<template>
    <main class="w-full lg:h-screen h-full xl:max-w-[1280px] xl:px-0 mx-auto flex flex-wrap justify-between lg:px-20 lg:py-0 md:pt-24 md:px-14 pt-20 px-8 items-center">
        ...
        <div ref="rightHero" class="lg:w-1/2 lg:py-0 py-5 w-full h-full relative flex justify-center">
            <img src="/joy-stick.png" alt="" class="w-[80%] -z-10 h-full xl:h-[80%]">
