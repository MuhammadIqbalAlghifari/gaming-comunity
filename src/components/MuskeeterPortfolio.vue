<template>
    <section class="lg:p-20 md:p-14 p-8 flex max-w-screen-2xl mx-auto flex-wrap lg:flex-nowrap w-full lg:justify-between justify-center gap-y-5 lg:gap-y-0 items-center">
