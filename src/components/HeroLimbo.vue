<template>
    <section class="lg:p-20 p-12 md:p-14 max-w-screen-2xl mx-auto flex flex-wrap-reverse lg:flex-nowrap w-full lg:justify-between justify-center gap-y-5 lg:gap-y-0 items-center">
