<template>
    <section class="lg:p-20 p-8 md:p-14 xl:max-w-[1280px] xl:px-0 mx-auto flex flex-wrap-reverse lg:flex-nowrap w-full lg:justify-between justify-center gap-y-5 lg:gap-y-0 items-center">
