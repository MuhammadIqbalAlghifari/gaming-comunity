<template>
    <section class="lg:p-20 md:p-14 p-8 xl:max-w-[1280px] xl:px-0 mx-auto flex flex-wrap lg:flex-nowrap lg:justify-between justify-center gap-y-5 lg:gap-y-0 items-center w-full">
