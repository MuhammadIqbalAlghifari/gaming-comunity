<template>
    <section class="lg:p-20 md:p-14 p-8 flex flex-wrap lg:flex-nowrap xl:max-w-[1280px] xl:px-0 mx-auto lg:justify-between justify-center lg:items-start items-center w-full h-auto gap-y-5 lg:gap-x-10">
